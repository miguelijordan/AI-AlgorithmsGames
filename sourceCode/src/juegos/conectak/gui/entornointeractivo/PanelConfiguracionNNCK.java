...
public class PanelConfiguracionNNCK extends PanelConfiguracionEvaluador {
	...
	public PanelConfiguracionNNCK() {
		...
		textFieldNNeuronasIntermedias.setText(String.valueOf(InterfazEvaluadorNNCK.N_NEURONAS_INTERMEDIAS));
		...
		textFieldTasaAprendizaje.setText(String.valueOf(InterfazEvaluadorNNCK.TASA_APRENDIZAJE));
		...
		textFieldMomento.setText(String.valueOf(InterfazEvaluadorNNCK.MOMENTO));
	...
	public Evaluador evaluador(EstadoJuego e) {
		int neuronas = InterfazEvaluadorNNCK.N_NEURONAS_INTERMEDIAS;
		double tasaAprendizaje = InterfazEvaluadorNNCK.TASA_APRENDIZAJE;
		double momento = InterfazEvaluadorNNCK.MOMENTO;
		...
		return new EvaluadorNNCK(ck.tablero().nFilas(), ck.tablero().nColumnas(), neuronas, tasaAprendizaje, momento);
	}
